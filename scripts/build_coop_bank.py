...
# decision this workbook stops at FY2014. 11 years used: FY2024-FY2014.
YEARS = [
...
STATEMENTS_SOURCES = (
    ...
    "FY2014-FY2016 only, blank in other years, alongside the same bottom-line/OCI rows used throughout.\n\n"
...
bw.add_balance_sheet_sheet(
    ...
    rows=[
        ...
        ("DATA", "Investments in joint ventures", {"FY2016": 6.0, "FY2015": 4.9, "FY2014": 5.3}),
        ...
        ("DATA", "Other borrowed funds", {"FY2017": 0.0, "FY2016": 472.6, "FY2015": 459.9, "FY2014": 196.4}),
        ...
        ("DATA", "Current tax liabilities", {"FY2015": 0.3, "FY2014": 0.3}),
        ...
        ("DATA", "Non-controlling interests", {"FY2015": 0.0, "FY2014": 34.5}),
        ("TOTAL", "Total equity", {
...
bw.add_income_statement_sheet(
    ...
    subtitle="Bank Company-only basis; bottom-line profit plus OCI detail (FY2017-FY2024), full income statement "
             "(FY2014-FY2016 only, see source note), £m",
    rows=[
        ("SECTION", "Full income statement (FY2014-FY2016 only, pre-restructuring - see source note)", {}),
        ("DATA", "Net interest income", {"FY2016": 220.3, "FY2015": 299.2, "FY2014": 345.0}),
        ...
        ("TOTAL", "Operating income", {"FY2016": 322.0, "FY2015": 240.7, "FY2014": 466.9}),
        ...
        ("TOTAL", "(Loss) before taxation", {"FY2016": -477.1, "FY2015": -610.6, "FY2014": -264.2}),
        ("DATA", "Income tax", {"FY2016": 58.4, "FY2015": -12.2, "FY2014": 39.0}),
        ("TOTAL", "(Loss) for the financial year (incl. non-controlling interests)", {
            "FY2016": -418.7, "FY2015": -622.8, "FY2014": -225.2,
        }),
...
rows = [
    ...
    ("DATA", "Pension scheme adjustments", {
        ...
        "FY2019": -13.9, "FY2018": 4.4, "FY2017": -51.9,
    }),
