...
KM1_SOURCES = (
    ...
    "because the FY2022 edition's 2021 comparative publishes them. Since 2026-09-19 (GA-020) the LCR metric "
    "sheet carries the same three FY2021 figures from the same page; the FY2021 edition itself prints no KM1 "
    "table, only an in-year average LCR of 335% in prose (p.27), recorded in the LCR sheet's note."
)
...
# reclassified. FY2021 LCR, FY2019 HQLA/outflows and FY2016/FY2015 HQLA were FOUND
# in the Bank's own Pillar 3 editions (page images read) and are now figures.
def _nsfr_np(y):
    return (f"Not published – OakNorth {y} Pillar 3 (full text searched 2026-09-19) names NSFR only as a ratio "
            "ALCO monitors; no NSFR figure. UK NSFR disclosure began 1 Jan 2022.")
NSFR_NP = {y: _nsfr_np(y) for y in ["FY2020", "FY2019", "FY2018", "FY2017", "FY2016", "FY2015"]}
NSFR_NP["FY2021"] = ("Not published – FY2021 Pillar 3 has no NSFR figure; FY2022 Pillar 3 p.19 prints 'n/a' for 2021: "
                     "'UK did not adopt the EBA NSFR in 2021 therefore comparative data cannot be presented'")
MREL_NP = {y: (f"Not published – OakNorth {y} Pillar 3 (full text searched 2026-09-19) contains no MREL ratio or "
               "MREL requirement figure") for y in YEARS}
metric("LCR", "£'000 / %", [
    ("Total high-quality liquid assets (HQLA), weighted value-average", {"FY2025": 2609639, "FY2024": 1876341, "FY2023": 1189319, "FY2022": 556199, "FY2021": 452554, "FY2020": 469400, "FY2019": 539900, "FY2018": 356800, "FY2017": 149400, "FY2016": 51700, "FY2015": 53200}),
    ("Total net cash outflows, adjusted value", {"FY2025": 555901, "FY2024": 384055, "FY2023": 325606, "FY2022": 158569, "FY2021": 142079, "FY2020": 139100, "FY2019": 143200, "FY2018": 72800, "FY2017": 21000,
        "FY2016": "Not published – FY2016 Pillar 3 p.27 gives only year-end HQLA (£51.7m) and says the Bank held 'a significantly high buffer over the minimum LCR'; no outflows figure",
        "FY2015": "Not published – FY2015 Pillar 3 p.24 gives only LAB-eligible investments (£53.2m) and a 'significantly higher buffer over the minimum LCR'; no outflows figure"}),
    ("Liquidity Coverage Ratio", {"FY2025": "478%", "FY2024": "489%", "FY2023": "365%", "FY2022": "351%", "FY2021": "319%", "FY2020": "338%", "FY2019": "377%", "FY2018": "490%", "FY2017": "713%",
        "FY2016": "Not published – FY2016 Pillar 3 p.27 says only that the Bank had 'a significantly high buffer over the minimum LCR limits'; no ratio printed",
        "FY2015": "Not published – FY2015 Pillar 3 p.24 says only that the Bank held 'significantly higher buffer over the minimum LCR limits'; no ratio printed"}),
 ], note="The 2022–2025 LCR figures are the reported average/weighted-value disclosures (UK KM1 template). CORRECTED: FY2023 previously showed the FY2023 Pillar 3 disclosure's UK LIQ1 table's Dec-23 quarter-end point-in-time snapshot (HQLA 1,441,255; net cash outflows 374,177; LCR 385%) rather than that same document's own UK KM1 summary table average-of-4-quarters figure used for every other year - corrected to the average basis (HQLA 1,189,319; net cash outflows 325,606; LCR 365%) for consistency across all 5 years. FY2021 (ADDED 2026-09-19, GA-020): HQLA 452,554, net cash outflows 142,079 and LCR 319% are the 2021 comparative column of the FY2022 Pillar 3's UK KM1 table (p.19, page image read) - the same weighted-value-average basis as FY2022+. The FY2021 edition itself prints no KM1 table; its Liquidity risk section (p.27) instead says 'unencumbered high-quality liquid assets of £486.4 million' at 31 December 2021 and 'Average Liquidity Coverage Ratio (LCR) during the year was 335% (2020: 338%)'. Two editions, two figures for the same year on different bases - both recorded, neither altered. FY2017/FY2018/FY2019 LCR figures are OakNorth's own 30-day, point-in-time (year-end) ratio, sourced from the FY2018 and FY2019 Pillar 3 reports' Liquidity risk sections - a different, less-smoothed basis than the FY2022+ average-of-4-quarters figures (FY2019's own report separately discloses a quarterly average of 395%, closer to the later years' basis, shown here only in this note for comparability). FY2020's own Pillar 3 report discloses liquidity buffer £469.4m, net cash outflows £139.1m, and a 30-day LCR of 338% (the FY2021 report repeats the LCR comparative as 338%); these are now populated. FY2019 HQLA/outflows (ADDED 2026-09-19) are the 'Liquidity buffer 539.9' and 'Net Cash outflows 143.2' (£m) of the FY2019 Pillar 3's liquidity table, p.38 (page image read). FY2016 HQLA 51,700 is the FY2016 Pillar 3 p.27 statement 'the Bank held high quality liquid assets of £51.7 million (2015: £53.2 million)', and FY2015's 53,200 is that edition's 2015 comparative - the FY2015 edition itself (p.24) calls the same £53.2m 'LAB eligible investments', the pre-LCR liquid asset buffer. Both are YEAR-END amounts, like FY2017-FY2020, not quarterly averages. FY2015/FY2016 report no LCR ratio and no outflows - the UK LCR minimum only began binding from October 2015 and the Bank's earliest reports do not yet present the ratio numerically.")
metric("NSFR", "£'000 / %", [
    ("Total available stable funding", {"FY2025": 6855628, "FY2024": 6303663, "FY2023": 4831446, "FY2022": 3748427, "FY2021": NSFR_NP["FY2021"], "FY2020": NSFR_NP["FY2020"], "FY2019": NSFR_NP["FY2019"], "FY2018": NSFR_NP["FY2018"], "FY2017": NSFR_NP["FY2017"], "FY2016": NSFR_NP["FY2016"], "FY2015": NSFR_NP["FY2015"]}),
    ("Total required stable funding", {"FY2025": 3608230, "FY2024": 3324269, "FY2023": 2993447, "FY2022": 2436946, "FY2021": NSFR_NP["FY2021"], "FY2020": NSFR_NP["FY2020"], "FY2019": NSFR_NP["FY2019"], "FY2018": NSFR_NP["FY2018"], "FY2017": NSFR_NP["FY2017"], "FY2016": NSFR_NP["FY2016"], "FY2015": NSFR_NP["FY2015"]}),
    ("Net Stable Funding Ratio", {"FY2025": "190%", "FY2024": "190%", "FY2023": "161%", "FY2022": "154%", "FY2021": NSFR_NP["FY2021"], "FY2020": NSFR_NP["FY2020"], "FY2019": NSFR_NP["FY2019"], "FY2018": NSFR_NP["FY2018"], "FY2017": NSFR_NP["FY2017"], "FY2016": NSFR_NP["FY2016"], "FY2015": NSFR_NP["FY2015"]}),
...
metric("MREL Ratio", None, [("MREL ratio", dict(MREL_NP))], note="No MREL ratio is presented in any of OakNorth's eleven annual Pillar 3 disclosures FY2015-FY2025 (each re-downloaded from the P3_URLS above and its full text searched for 'MREL' / 'eligible liabilities' on 2026-09-19: the only hits are the capital-instruments template's subordination row and, in FY2024/FY2025, a remark that Tier 2 terms follow the UK CRR's MREL drafting). The Annual Reports FY2022-FY2025 were searched the same way with no MREL hit. This is a documented non-disclosure, not a zero.")
...
bw.add_overview_sheet(
    ...
    ratios=[
        ...
        ("LCR", {"FY2025": "478%", "FY2024": "489%", "FY2023": "365%", "FY2022": "351%", "FY2021": "319%", "FY2020": "338%", "FY2019": "377%", "FY2018": "490%", "FY2017": "713%", "FY2016": "Not disclosed", "FY2015": "Not disclosed"}),
