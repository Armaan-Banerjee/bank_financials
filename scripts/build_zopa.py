...
def p3_sources(page="14-15"):
    return (
        ...
        f"transcribed here, because neither sheet has a row on that basis. SOURCE DISCREPANCY VERIFIED FROM "
        f"PAGE IMAGES 2026-09-20: the FY2020 Pillar 3's own-year 2020 column prints RWA £390.9m and CET1 ratio "
        f"29.5%, while the FY2021 Annual Report comparative used for the main FY2020 cells prints £390.5m and "
        f"29%. Both source statements have now been read from rendered page images; the workbook retains the "
