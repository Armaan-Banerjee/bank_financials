...
def p3_sources():
    return (
        ...
        f"FY2021: FY2021 comparative column of the FY2022 Pillar III Disclosure, section 2 p.7 "
        f"(FY2021's own standalone Pillar 3 document could not be fetched this session for the "
        f"same reason as FY2023 above) - {P3_2022_URL}\n"
