...
def statements_sources(kind):
    return (
        ...
        + ENTITY_NOTE + " All five Companies House PDFs are scanned/image-only; figures were transcribed by rendering and reading each statutory-account page directly."
    )


BS_SOURCES = (
    statements_sources("Statement of Financial Position")
    + "\n\nPage references: FY2025 & FY2024 p.31; FY2023 & FY2022 p.26; FY2021 & FY2020 p.21."
    ...
    "does not carry the line at all). Deferred tax asset is reported as nil (-) in every year shown."
)
PL_SOURCES = (
    statements_sources("Statement of Profit or Loss and Other Comprehensive Income")
    + "\n\nPage references: FY2025 & FY2024 p.30; FY2023 & FY2022 p.25; FY2021 & FY2020 p.20."
    ...
    "statement structure, not a missing figure. All five years' Loss/Profit for the year and Total comprehensive "
    "income/(loss) rows are the fully comparable rows across the whole 5-year window."
)
EQ_SOURCES = (
    ...
    "equity - zero undocumented plug rows across all 5 years, independently cross-checked at 31 March 2023 (£8,637k) "
    "which appears identically as a closing balance in the FY2023 report and an opening balance in the FY2025 "
    "report's own equity roll-forward. FY2025's 'Capital reorganisation' row is a genuine reclassification between "
    "Share capital and Share premium with zero net effect on Total equity, reproduced as reported."
)
AQ_SOURCES = (
    statements_sources("Note 14, Loans and advances to customers, by IFRS 9 stage")
    + "\n\nPage references: FY2025 & FY2024 p.57; FY2023 & FY2022 p.50; FY2021 p.42 (FY2020 comparative not shown, "
    "loan book had not yet begun disbursing at scale)."
    + "\n\nAll 5 years' Total Net Loans ties exactly to the Balance Sheet's own Loans and advances to customers "
    "line. FY2025 is the first year the loan book is split between Unsecured personal loans and Secured loans; "
    "FY2024-FY2021 are shown entirely under Unsecured personal loans as the Bank's own note structure carried no "
    ...
    "coverage ratio are derived from the note's own gross/ECL figures."
)
...
BS_ROWS = [
    ("SECTION", "Assets", {}),
    ("DATA", "Cash and cash equivalents", {"FY2025": 90674, "FY2024": 247547, "FY2023": 5264, "FY2022": 4159, "FY2021": 6720}),
    ("DATA", "Investment securities", {"FY2024": 16800, "FY2023": 46059, "FY2022": 16543, "FY2021": 26700}),
    ("DATA", "Loans and advances to customers", {"FY2025": 277269, "FY2024": 83069, "FY2023": 55364, "FY2022": 57279, "FY2021": 8585}),
    ("DATA", "Amounts owed by related party", {"FY2025": 313, "FY2024": 178, "FY2023": 994, "FY2022": 158, "FY2021": 145}),
    ("DATA", "Other assets", {"FY2025": 403, "FY2024": 607, "FY2023": 408, "FY2022": 403, "FY2021": 429}),
    ("DATA", "Property and equipment", {"FY2025": 565, "FY2024": 814, "FY2023": 967, "FY2022": 1121, "FY2021": 1294}),
    ("DATA", "Intangible assets", {"FY2025": 331, "FY2024": 359, "FY2023": 536, "FY2022": 2310, "FY2021": 2644}),
    ("DATA", "Deferred tax asset", {"FY2025": 0, "FY2024": 0, "FY2023": 0, "FY2022": 0, "FY2021": 0}),
    ("TOTAL", "Total assets", {"FY2025": 369555, "FY2024": 349374, "FY2023": 109592, "FY2022": 81973, "FY2021": 46517}),
    ("SECTION", "Liabilities", {}),
    ("DATA", "Customer deposits", {"FY2025": 340963, "FY2024": 338301, "FY2023": 98503, "FY2022": 69516, "FY2021": 31955}),
    ("DATA", "Amounts owed to related party", {"FY2025": 585, "FY2024": 334, "FY2023": 747, "FY2022": 375, "FY2021": 193}),
    ("DATA", "Other liabilities", {"FY2025": 2410, "FY2024": 2126, "FY2023": 1705, "FY2022": 1760, "FY2021": 2052}),
    ("TOTAL", "Total liabilities", {"FY2025": 343958, "FY2024": 340761, "FY2023": 100955, "FY2022": 71651, "FY2021": 34200}),
    ("SECTION", "Equity", {}),
    ("DATA", "Share capital", {"FY2025": 422, "FY2024": 24930, "FY2023": 24930, "FY2022": 24930, "FY2021": 24930}),
    ("DATA", "Share premium", {"FY2025": 78104, "FY2024": 26996, "FY2023": 15996, "FY2022": 4996, "FY2021": 496}),
    ("DATA", "Accumulated loss", {"FY2025": -52929, "FY2024": -43313, "FY2023": -32289, "FY2022": -19604, "FY2021": -13109}),
    ("TOTAL", "Total equity", {"FY2025": 25597, "FY2024": 8613, "FY2023": 8637, "FY2022": 10322, "FY2021": 12317}),
    ("TOTAL", "Total liabilities and equity", {"FY2025": 369554, "FY2024": 349374, "FY2023": 109592, "FY2022": 81973, "FY2021": 46517}),
]
...
PL_ROWS = [
    ("SECTION", "Income", {}),
    ("DATA", "Interest on investment securities", {"FY2025": 204, "FY2024": 2470, "FY2023": 533, "FY2022": 18, "FY2021": 7}),
    ...
    ("DATA", "Interest payable and similar charges", {"FY2025": -16599, "FY2024": -8251, "FY2023": -1790, "FY2022": -585, "FY2021": -99}),
    ("TOTAL", "Net interest income", {"FY2025": 8430, "FY2024": 5271, "FY2023": 6825, "FY2022": 3052, "FY2021": 132}),
    ...
    ("DATA", "Administrative expenses", {"FY2025": -14212, "FY2024": -10705, "FY2023": -8651, "FY2022": -6331, "FY2021": -5326}),
    ("DATA", "Impairment losses on financial instruments", {"FY2025": -5197, "FY2024": -3452, "FY2023": -10820, "FY2022": -2438, "FY2021": -448}),
    ("DATA", "Depreciation", {"FY2025": -352, "FY2024": -178, "FY2023": -173, "FY2022": -182, "FY2021": -195}),
    ("DATA", "Amortisation", {"FY2025": -101, "FY2024": -241, "FY2023": -480, "FY2022": -631, "FY2021": -482}),
    ("DATA", "Other expenses", {"FY2025": 695, "FY2024": -2000, "FY2023": -360, "FY2022": -80, "FY2021": -2}),
    ("TOTAL", "Loss before tax", {"FY2025": -9616, "FY2024": -11024, "FY2023": -12685, "FY2022": -6495, "FY2021": -6321}),
    ("DATA", "Income tax expense", {"FY2025": 0, "FY2024": 0, "FY2023": 0, "FY2022": 0, "FY2021": 0}),
    ("TOTAL", "Loss for the year", {"FY2025": -9616, "FY2024": -11024, "FY2023": -12685, "FY2022": -6495, "FY2021": -6321}),
    ("TOTAL", "Total comprehensive loss for the year, net of tax", {"FY2025": -9616, "FY2024": -11024, "FY2023": -12685, "FY2022": -6495, "FY2021": -6321}),
]
...
AQ_ROWS = [
    ...
    ("DATA", "Stage 1 (12-month ECL)", {"FY2025": 244224, "FY2024": 81546, "FY2023": 40573, "FY2022": 54865, "FY2021": 8208}),
    ("DATA", "Stage 2 (lifetime ECL, not credit-impaired)", {"FY2025": 18452, "FY2024": 60, "FY2023": 17958, "FY2022": 3373, "FY2021": 751}),
    ("DATA", "Stage 3 (credit-impaired)", {"FY2025": 19618, "FY2024": 15306, "FY2023": 9213, "FY2022": 1771, "FY2021": 69}),
    ("DATA", "POCI loans", {"FY2025": 676}),
    ("TOTAL", "Total gross loans and advances", {"FY2025": 282970, "FY2024": 96912, "FY2023": 67744, "FY2022": 60009, "FY2021": 9028}),
    ...
    ("TOTAL", "Total allowances for ECLs", {"FY2025": -5701, "FY2024": -13843, "FY2023": -12380, "FY2022": -2730, "FY2021": -443}),
    ("TOTAL", "Total net loans and advances", {"FY2025": 277269, "FY2024": 83069, "FY2023": 55364, "FY2022": 57279, "FY2021": 8585}),
    ("SECTION", "Asset quality ratios", {}),
    ("DATA", "Stage 3 (NPL) ratio, gross", {"FY2025": "6.93%", "FY2024": "15.79%", "FY2023": "13.60%", "FY2022": "2.95%", "FY2021": "0.76%"}),
    ("DATA", "Stage 3 coverage ratio (Stage 3 ECL / Stage 3 gross)", {"FY2025": "7.61%", "FY2024": "85.71%", "FY2023": "88.56%", "FY2022": "82.95%", "FY2021": "89.86%"}),
]
...
bw.add_not_disclosed_metric_sheets(
    ["Total RWAs"],
    p3_sources(),
    per_note={"Total RWAs": "No numeric standalone value was identified in the FY2021-FY2025 annual accounts reviewed; no value has been derived."},
)
bw.add_not_disclosed_metric_sheets(
    ["RWA Breakdown"],
    p3_sources(),
    per_note={"RWA Breakdown": "No RWA category breakdown (UK OV1 template or equivalent) was identified in the FY2021-FY2025 annual accounts reviewed; the accounts do not publish a standalone Pillar 3 document and Total RWAs itself is undisclosed."},
)
bw.add_not_disclosed_metric_sheets(
    ["Leverage Ratio"],
    p3_sources(),
    per_note={"Leverage Ratio": "No numeric standalone value was identified in the FY2021-FY2025 annual accounts reviewed; no value has been derived."},
)
...
bw.add_overview_sheet(
    ...
    balance_sheet_totals=[
        ("Total assets", {"FY2025": 369555, "FY2024": 349374, "FY2023": 109592, "FY2022": 81973, "FY2021": 46517}),
        ("Loans and advances to customers", {"FY2025": 277269, "FY2024": 83069, "FY2023": 55364, "FY2022": 57279, "FY2021": 8585}),
        ("Customer deposits", {"FY2025": 340963, "FY2024": 338301, "FY2023": 98503, "FY2022": 69516, "FY2021": 31955}),
        ("Total equity", {"FY2025": 25597, "FY2024": 8613, "FY2023": 8637, "FY2022": 10322, "FY2021": 12317}),
    ],
    balance_sheet_unit="£'000",
    income_statement_totals=[
        ("Net interest income", {"FY2025": 8430, "FY2024": 5271, "FY2023": 6825, "FY2022": 3052, "FY2021": 132}),
        ("Administrative expenses", {"FY2025": -14212, "FY2024": -10705, "FY2023": -8651, "FY2022": -6331, "FY2021": -5326}),
        ("Loss for the year", {"FY2025": -9616, "FY2024": -11024, "FY2023": -12685, "FY2022": -6495, "FY2021": -6321}),
    ],
    income_statement_unit="£'000",
    equity_changes_totals=[
        ("Opening equity", {"FY2025": 8613, "FY2024": 8637, "FY2023": 10322, "FY2022": 12317}),
        ("Total comprehensive loss for the year", {"FY2025": -9616, "FY2024": -11024, "FY2023": -12685, "FY2022": -6495}),
        ("Other equity movements, net", {"FY2025": 26600, "FY2024": 11000, "FY2023": 11000, "FY2022": 4500}),
        ("Closing equity", {"FY2025": 25597, "FY2024": 8613, "FY2023": 8637, "FY2022": 10322}),
    ],
