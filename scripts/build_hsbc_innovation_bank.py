...
bw.add_rwa_breakdown_sheet(
    ...
    sources_text=(
        ...
        "in any of these years (site enumeration + Wayback CDX search both confirm this) - only the "
        "aggregate Total RWAs figure is disclosed in each year's own Annual Report 'Capital and leverage "
        "ratios' table (see Total RWAs metric sheet). Total ties exactly to the Total RWAs metric sheet's "
        "own FY2022 figure (7,496,138)."
    ),
)
