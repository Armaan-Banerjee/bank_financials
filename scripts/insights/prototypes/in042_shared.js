// Shared helpers for the IN-042 prototype's separate HTML pages
// (comparison.html, banks.html, bank-<slug>.html). Not a framework, no
// bundler - just one <script src="in042_shared.js"> tag per page, per the
// user's "multiple plain HTML pages, not an SPA" instruction.
...
// prototype now runs against a variable-size bank list, not a fixed 4.
let BANK_COLOR = {};
