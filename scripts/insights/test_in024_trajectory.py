...
class TrajectoryTests(unittest.TestCase):
    ...
    def test_trajectory_visuals_expose_filter_and_pdf_table_fallback(self):
        ...
        self.assertIn('class="in024-shared-bank-toggle"', html)
        self.assertIn('data-bank-preset="top"', html)
        self.assertIn('data-bank-preset="all"', html)
        self.assertIn('data-bank-preset="clear"', html)
        self.assertIn("The same selection applies to every trajectory and rank chart", html)
