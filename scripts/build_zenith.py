...
EQUITY_SOURCES = (
    ...
    "Opening balance (1 January 2014, the earliest year shown) is converted using the 31 Dec 2013 GBP/USD spot "
...
bw.add_equity_changes_sheet(
    ...
    subtitle="£'000, converted from USD - chronological 1 January 2014 through 31 December 2024. No FY2025 movement shown (no FY2025 Annual Report yet).",
    headers=EQ_HEADERS,
    rows=EQ_ROWS,
...
rows_usd = [
    ...
    ("DATA", "Proceeds from sale of property and equipment", {"FY2016": 0, "FY2015": 52412, "FY2014": 0}),
    ...
    ("DATA", "Proceeds from issue of share capital", {"FY2014": 50000000}),
