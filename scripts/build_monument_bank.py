...
STATEMENTS_SOURCES = (
    ...
    "as the Cash Flow Statement. Whole-£ source figures for FY2022 and FY2021 have been "
    "converted to £'000 (division by 1,000, decimals retained) - FY2024/FY2023 are already "
    "reported in £'000 by the source document.\n\n"
    ...
    "which is shown as 0.\n\n"
    "EQUITY LADDER: confirmed exactly across all 4 years - each year's own closing balance "
    ...
    "note, which is the finest granularity disclosed.\n\n"
...
bs_rows = [
    ("SECTION", "Assets", {}),
    ("DATA", "Cash and balances at central banks / with banks", {"FY2024": 3685561, "FY2023": 354658, "FY2022": 60337.153, "FY2021": 23888.337}),
    ...
    ("DATA", "Other assets", {"FY2024": 2576, "FY2023": 2522, "FY2022": 1102.443, "FY2021": 989.827}),
    ("DATA", "Tangible fixed assets", {"FY2024": 261, "FY2023": 164, "FY2022": 160.952, "FY2021": 140.030}),
    ("DATA", "Intangible fixed assets", {"FY2024": 12153, "FY2023": 11184, "FY2022": 10560.587, "FY2021": 9479.735}),
    ("TOTAL", "Total assets", {"FY2024": 5142928, "FY2023": 1047790, "FY2022": 185059.901, "FY2021": 45557.014}),
    ("SECTION", "Liabilities", {}),
    ...
    ("DATA", "Other liabilities and accruals", {"FY2024": 2882, "FY2023": 1417, "FY2022": 1673.075, "FY2021": 1340.705}),
    ("TOTAL", "Total liabilities", {"FY2024": 5073179, "FY2023": 994097, "FY2022": 150403.345, "FY2021": 3433.741}),
    ("SECTION", "Equity", {}),
    ("DATA", "Called up share capital", {"FY2024": 39, "FY2023": 32, "FY2022": 27.256, "FY2021": 25.730}),
    ("DATA", "Share premium reserve", {"FY2024": 129928, "FY2023": 87459, "FY2022": 61434.408, "FY2021": 58982.976}),
    ("DATA", "Shares to be issued", {"FY2024": 48, "FY2023": 13980, "FY2022": 2796.000, "FY2021": 724.816}),
    ("DATA", "Available-for-sale reserve", {"FY2024": -216, "FY2023": 575, "FY2022": 0}),
    ("DATA", "Accumulated losses", {"FY2024": -60050, "FY2023": -48353, "FY2022": -29601.108, "FY2021": -17610.249}),
    ("TOTAL", "Total equity", {"FY2024": 69749, "FY2023": 53693, "FY2022": 34656.556, "FY2021": 42123.273}),
    ("TOTAL", "Total liabilities and equity", {"FY2024": 5142928, "FY2023": 1047790, "FY2022": 185059.901, "FY2021": 45557.014}),
]
...
pl_rows = [
    ("SECTION", "Income", {}),
    ("DATA", "Interest receivable and similar income", {"FY2024": 148993, "FY2023": 20705, "FY2022": 2128.074, "FY2021": 0.730}),
    ("DATA", "Interest payable and similar charges", {"FY2024": -136868, "FY2023": -17400, "FY2022": -1784.745, "FY2021": -1.102}),
    ("TOTAL", "Net interest income/(expense)", {"FY2024": 12125, "FY2023": 3305, "FY2022": 343.329, "FY2021": -0.372}),
    ...
    ("TOTAL", "Total net income/(expense)", {"FY2024": 13680, "FY2023": 925, "FY2022": 3808.266, "FY2021": -0.372}),
    ("DATA", "Administrative expenses", {"FY2024": -26926, "FY2023": -20895, "FY2022": -18474.978, "FY2021": -9970.282}),
    ("DATA", "Impairment charge on loans and advances to customers", {"FY2024": -79, "FY2023": -83, "FY2022": -101.980, "FY2021": -2.664}),
    ("TOTAL", "Operating loss before taxation", {"FY2024": -13325, "FY2023": -20053, "FY2022": -14768.692, "FY2021": -9973.318}),
    ("DATA", "Taxation credit/(expense)", {"FY2024": 239, "FY2023": 693, "FY2022": 2059.137, "FY2021": 0}),
    ("TOTAL", "Loss for the financial year", {"FY2024": -13086, "FY2023": -19360, "FY2022": -12709.555, "FY2021": -9973.318}),
    ...
    ("TOTAL", "Other comprehensive income for the year", {"FY2024": -792, "FY2023": 576, "FY2022": 0, "FY2021": 0}),
    ("TOTAL", "Total comprehensive loss for the year", {"FY2024": -13878, "FY2023": -18784, "FY2022": -12709.555, "FY2021": -9973.318}),
]
...
bw.add_income_statement_sheet(
    ...
    subtitle="Company/standalone basis, £'000. FY2023 Company Net fee income/Total net income "
              ...
              "derivative and fee income lines.",
...
equity_rows = [
    ("TOTAL", "At 1 January 2021 (FY2021 opening)", (16.354, 18397.070, 15034.157, 0, -8250.492, 25197.089)),
...
bw.add_equity_changes_sheet(
    ...
    subtitle="Chronological roll-forward, oldest to newest, Company/standalone basis, £'000. "
              "Equity reconciliation ladder confirmed exactly across all 4 years - each year's "
