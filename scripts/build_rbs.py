...
KM1_SOURCES = (
    ...
    "LATEST-EDITION CHECK, RE-RUN AND CORRECTED 2026-09-18. The newest RBS plc ANNUAL Pillar 3 Report is the 2025 "
    "edition published 13 February 2026, already used here, and the newest annual report is the RBS plc Annual "
    "Report and Accounts 2025 of the same date - so the FY2025 columns above are current. RBS plc's year-end is "
    "31 December, so FY2026 had not closed at the date of this check.\n"
    "Two claims made by the 2026-09-17 version of this note are corrected here rather than left standing. It said "
    "'no half-year 2026 edition was found': one exists. RBS plc published an 'H1 2026 Pillar 3' on 12 August 2026 "
    "(https://investors.natwestgroup.com/~/media/Files/R/RBS-IR-V2/results-center/12082026/rbs-pillar-3-hy-2026.pdf), "
    "whose cover names The Royal Bank of Scotland plc and whose contents list 'UK KM1: Key metrics' - a half-year "
    "KM1 for 30 June 2026. It also said a quarterly RBS plc Pillar 3 report for Q1 2026 exists; a full "
    "enumeration of the 1 May 2026 results folder on 2026-09-18 found nine documents, all of them NatWest Group "
    "or NatWest Markets, and no RBS plc entry. The earlier claim could not be reproduced and should not be relied "
    "on without re-checking.\n"
    "THE H1 2026 EDITION IS DELIBERATELY NOT TRANSCRIBED HERE, and the omission is not an oversight. It reports a "
    "half-year date rather than a financial year-end, so it extends no column on this sheet; and this workbook "
    "carries no 'Interim Pillar 3' sheet, which is where a half-year disclosure belongs. Adding one for RBS plc "
    "is an open opportunity, not a gap in this sheet's year coverage.\n"
    "A FILENAME TRAP FOR WHOEVER CHECKS NEXT: NatWest's current filenames drop the '-plc', so "
    "'rbs-pillar-3-report.pdf' is the RBS plc document while 'rbs-plc-pillar-3-report.pdf' 404s in the 2026 "
    "folders. That 404 is an artefact of the naming change, not evidence of absence. Each results folder carries "
    "seven parallel entities (nwg-, nwh-, nwb-, nwm-, coutts-co-, rbsh-nv-, rbsi-); only the 'rbs-' files carry "
    "an RBS plc cover, and the RBS plc Pillar 3 appendix states outright that it covers 'The Royal Bank of "
    "Scotland plc (\"RBS plc\"), a subsidiary of NatWest Holdings Limited' - the modern entity, not the historic "
    "one now named NatWest Markets Plc.\n\n"
    "THE EMPTY LCR AND NSFR BLOCKS ARE CORROBORATED BY THE PRA'S OWN REGISTER, not only by the editions' own "
    "footnote. The Bank of England consolidated waivers register, read 2026-09-18, records The Royal Bank of "
    "Scotland Public Limited Company (FRN 114724) holding a 'DolSub permission' under Permissions and Waivers "
    "(CRR Firms) rule 2.2, running 01/01/2022 to 01/03/2027. That is a permission to meet and report liquidity at "
    "the sub-group level, and its window covers every year on this sheet from FY2022 onward. It confirms the "
    "figures are disclosed somewhere else rather than not at all - they are on the LCR and NSFR metric sheets on "
    "the UK DoLSub basis - which is a stronger statement than 'not disclosed'.\n\n" + ENTITY_NOTE
)
