...
KM1_SOURCES = (
    ...
    "directory - so the absence is specific to FY2026, not a site-wide outage or a block. RE-RUN 2026-09-18 and "
    "UNCHANGED: app.js is still 930,330 bytes and still lists the same six StreamBank PDFs and the same two "
    "Pillar 3 files; March-2025-Pillar-3-Disclosures.pdf still serves 779,478 bytes of application/pdf with "
    "%PDF magic bytes (the same-day positive control) while March-2026-Pillar-3-Disclosures.pdf and "
    "FY26-Pillar-3-StreamBank-PLC.pdf both return the 25,989-byte text/html soft-404 shell.\n"
