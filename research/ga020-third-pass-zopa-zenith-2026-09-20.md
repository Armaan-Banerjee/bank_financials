...
The official [Zopa Bank Limited Pillar 3 Disclosures, 31 December 2020](https://www.datocms-assets.com/23873/1658745471-2020-zopa-pillar-3-disclosures.pdf) is available through Zopa's DatoCMS asset host. Printed p.4 (PDF p.4) has separate 2020 and 2019 columns: CET1, Tier 1 and total capital ratios 29.5% / 25.1%; RWA £390.9m / £52.9m; leverage 38.1% / 54.3%; LCR 13,597% / 10,059%. The document's printed p.15 (“Capital composition”) also reports CET1 capital £115.4m / £13.3m. The report identifies Zopa Bank Limited and says the disclosure is prepared only for that Bank (printed p.4).

Verification update (2026-09-20): the downloaded 46-page PDF was rendered locally and the figures were read directly from page images. Printed p.4 confirms both years' key ratios, RWAs, leverage and LCR; printed p.15 confirms CET1 capital of £115.4m / £13.3m and the RWA composition. The FY2019 leverage (54.3%) and LCR (10,059%) are already represented in `build_zopa.py` on separate year-end/Annual Report-basis rows; do not duplicate them onto the KM1 average-basis rows. The FY2020 P3 values (£390.9m and 29.5%) differ from the currently recorded FY2020 FY2021-ARA comparative (£390.5m and 29%); both source statements are now image-verified. Preserve the discrepancy and do not silently replace the existing values.
